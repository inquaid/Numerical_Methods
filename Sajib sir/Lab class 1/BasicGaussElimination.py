...
if list_of_equation[2][2] != 0:
    z = list_of_equation[2][3] / list_of_equation[2][2]
else:
    z = 0
# print(z)

if list_of_equation[1][1] != 0:
    y = (list_of_equation[1][3] - (list_of_equation[1][2] * z)) / list_of_equation[1][1]
else:
    y = 0
# print(list_of_equation[1][2])
# print(y)

if list_of_equation[0][0] != 0:
    x = ( list_of_equation[0][3] - (list_of_equation[0][1] * y) - (list_of_equation[0][2] * z)  ) / list_of_equation[0][0]
else:
    x = 0
# print(x)

print(f'\nx = {x}\ny = {y}\nz = {z}')
# print(list_of_equation[1][3])
# print(div4)
# for i in list_of_equation:
#     print(i) 
